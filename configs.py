...
def parse_seg_args():
    ...
    parser.add_argument('--num_workers', type=int, default=5, help='number of workers to load data')
    ...
    parser.add_argument('--data_root', type=str, default=os.path.join(base_dir, 'data', 'train_data'), help='Root dir of dataset')
    parser.add_argument('--cases_split', type=str, default=os.path.join(base_dir, 'data', 'split', 'brats2021_split.csv'), help='Name & split for noisy data')
    parser.add_argument('--cases_split_2', type=str, default=os.path.join(base_dir, 'data', 'split', 'Adults_brats2021_split.csv'), help='Name & split for noisy data')

    parser.add_argument('--input_channels', '--n_views', type=int, default=5,
    ...
    parser.add_argument('--scheduler', type=str, default='poly', help='scheduler',
        choices=['warmup_cosine', 'cosine', 'step', 'poly', 'none'])

    parser.add_argument('--clean_scheduler', type=str, default='poly', help='scheduler',
                        choices=['warmup_cosine', 'cosine', 'step', 'poly', 'none'])
    ...
    # u-net
    parser.add_argument('--unet_arch', type=str, default='unetr',
    ...
    parser.add_argument('--ds_layer', type=int, default=0,
    ...
    parser.add_argument('--infer_batch_size', type=int, default=1, help='batchsize for inference')
...
#     parser.add_argument('--amp', action='store_true', help='using mixed precision')
#     parser.add_argumسثثيent('--data_parallel', action='store_true', help='using data parallel')
#
#     # path & dir
#     parser.add_argument('--exp_dir', type=str, default=r'C:\Users\USER\Master-Degree\small-unet\trail', help='experiment dir')
#     parser.add_argument('--save_freq', type=int, default=10, help='model save frequency (epoch)')
#     parser.add_argument('--print_freq', type=int, default=5, help='print frequency (iteration)')
#
#     # data
#     parser.add_argument('--dataset', type=str, default='brats2021', help='dataset hint',
#         choices=['brats2021', 'brats2018'])
#     parser.add_argument('--data_root', type=str, default=r'C:\\Users\\USER\\Master-Degree\\DATA\\BraTS2021\\archive\\BraTS2021_Training_Data', help='root dir of dataset')
#     parser.add_argument('--clean_data_root', type=str, default=r'C:\\Users\\USER\\Master-Degree\\DATA\\BraTS2021\\archive\\BraTS2021_Training_Data\\errored_train', help='root dir of dataset')
#
#     parser.add_argument('--cases_split', type=str, default=r'C:\\Users\\USER\\Master-Degree\\3DUNet-BraTS-PyTorch-master\\3DUNet-BraTS-PyTorch-master\\data\\split\\brats2021_split_fold0.csv', help='name & split')
#     parser.add_argument('--clean_cases_split', type=str, default=r'C:\Users\USER\Master-Degree\3DUNet-BraTS-PyTorch-master\3DUNet-BraTS-PyTorch-master\data\split\clean', help='name & split')
#
...
#         choices=['adam', 'adamw', 'sgd'])
#
#     parser.add_argument('--meta_optim', type=str, default='adam', help='optimizer',
#         choices=['adam', 'adamw', 'sgd'])
#
#     parser.add_argument('--beta1', default=0.9, type=float, metavar='M',
#         help='momentum for sgd, beta1 for adam')
...
#         choices=['warmup_cosine', 'cosine', 'step', 'poly', 'none'])
#     parser.add_argument('--meta_scheduler', type=str, default='none', help='scheduler',
#         choices=['warmup_cosine', 'cosine', 'step', 'poly', 'none'])
#     parser.add_argument('--warmup_epochs', type=int, default=5, help='warm up epochs')
#     parser.add_argument('--milestones', type=int, nargs="+", default=[60, 80],
#         help='milestones for multistep decay')
...
#     parser.add_argument('--block', type=str, default='plain', choices=['plain', 'res'],
#         help='Type of convolution block')
#     parser.add_argument('--channels_list', nargs='+', type=int, default=[32, 64, 128, 256, 320],
#         help="#channels of every levels of decoder in a top-down order")
#     parser.add_argument('--kernel_size', type=int, default=3, help="size of conv kernels")
#     parser.add_argument('--dropout_prob', type=float, default=0.0, help="prob of dropout")
#     parser.add_argument('--norm', type=str, default='instance',
